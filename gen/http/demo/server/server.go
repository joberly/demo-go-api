...
func New(
	...
	return &Server{
		...
		Rand: NewRandHandler(e.Rand, mux, decoder, encoder, errhandler, formatter),
	}
}
...
// MountRandHandler configures the mux to serve the "demo" service "rand"
// endpoint.
func MountRandHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rand", f)
}

// NewRandHandler creates a HTTP handler which loads the HTTP request and calls
// the "demo" service "rand" endpoint.
func NewRandHandler(
	...
	var (
		decodeRequest  = DecodeRandRequest(mux, decoder)
		encodeResponse = EncodeRandResponse(encoder)
		encodeError    = EncodeRandError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "rand")
